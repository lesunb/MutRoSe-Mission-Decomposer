...
void simple_hddl_output(ostream & dout){
	...
	for(auto s : sort_out) {
		...
		dout << endl;
		/*dout << "########################################" << endl;
		for (auto c : s.second) dout << c << endl;
		dout << "########################################" << endl;*/
	}
	dout << "#end_sorts" << endl;
	...
	/*
	Here we print the predicates, their number of arguments and the 'id' of the type of each of the arguments
	*/
	for(auto p : predicate_out){
		...
		dout << endl;
		/*dout << "########################################" << endl;
		for(string s : p.second.argument_sorts) dout << "argument sort: " << s << endl;
		dout << "########################################" << endl;*/
	}
	...
	/*
	As far as understood, predicate mutexes are the ones that appear positively and negatively
	in methods that decompose the same abstract task
	*/
	for (auto [one, two] : mutexPredicates){
		/*dout << "########################################" << endl;
		dout << "one : " << one << " | two: " << two << endl;
		dout << "########################################" << endl;*/
	...
	/*for(auto at : abstract_tasks){
		dout << "Abstract: " << at.name << endl;
	}
	for(auto pt : primitive_tasks){
		dout << "Primitive: " << pt.name << endl;
	}*/
